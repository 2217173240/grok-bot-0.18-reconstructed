...
export const BROWSER_USE_SUBAGENT_DESCRIPTION = [
  "Delegate a self-contained web task to a subagent that drives your box's browser at the page level — navigating, reading structured page snapshots, clicking elements by reference, filling forms, and taking screenshots — without touching the desktop's mouse or keyboard.",
